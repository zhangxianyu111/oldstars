...
public class DateUtil{
    ...
    //public static final String DATE_FORMAT_YYYYMMDD_REXP = "[1-9]\\d{3}(((0[13578]|1[02])([0-2]\\d|3[01]))|((0[469]|11)([0-2]\\d|30))|(02([01]\\d|2[0-8])))";
    public static final String DATE_FORMAT_YYYYMMDD_REXP = "([0-9]{4})(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])";

    /**
     * 日期格式，年月日，用横杠分开，例如：2006-12-25，2008-08-08
     */
    public static final String DATE_FORMAT_YYYY_MM_DD = "yyyy-MM-dd";
    public static final String DATE_FORMAT_YYYY_MM_DD_REXP = "^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])))))|(\\d{2}(([02468][1235679])|([13579][01345789]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))";
    ...
    public static final String DATE_TIME_FORMAT_YYYYMMDDHHMISS_REXP = "([0-9]{4})(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])([01][0-9]|2[0-3])[0-5][0-9][0-5][0-9]";
    ...
    private static String[] parsePatterns = {"yyyy-MM-dd","yyyy年MM月dd日",
            ...
            "yyyy/MM/dd HH:mm:ss", "yyyy/MM/dd HH:mm", "yyyyMMdd","yyyy-MM-dd HH:mm:ss,sss"};
    ...
    public static boolean isRqFormat(String mes){
        Pattern pattern = Pattern.compile(DATE_FORMAT_YYYYMMDD_REXP);
        Matcher matcher = pattern.matcher(mes);
        if (matcher.matches()) {
            pattern = Pattern.compile("(\\d{4})(\\d{2})(\\d{2})");
            matcher = pattern.matcher(mes);
     ...
     * @throws Exception
     */
    public static boolean hourMinuteBetween(Date nowDate, Date startDate, Date endDate) throws Exception{
